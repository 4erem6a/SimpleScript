...
public final class CallExpression extends Expression {
    ...
    public CallExpression(Expression expression, boolean lastArray, Expression... args) {
    ...
    public Value eval() {
        ...
        throw new InvalidValueTypeException(value.getType(), Operations.Call);
    }
